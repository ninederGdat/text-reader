...
export interface DocumentCollection<EntryResultType extends Record<string, any> = any, EntryInputType extends Record<string, any> = EntryResultType> extends ArangoCollection {
     ...
     * ```
     */
    properties(): Promise<connection.ArangoApiResponse<CollectionDescription & CollectionProperties>>;
    /**
     ...
     * ```
     */
    properties(properties: CollectionPropertiesOptions): Promise<connection.ArangoApiResponse<CollectionDescription & CollectionProperties>>;
    /**
     ...
     * ```
     */
    count(): Promise<connection.ArangoApiResponse<CollectionDescription & CollectionProperties & {
        count: number;
    }>>;
    /**
     ...
     * ```
     */
    figures(details?: boolean): Promise<connection.ArangoApiResponse<CollectionDescription & CollectionProperties & {
        count: number;
     ...
     * ```
     */
    revision(): Promise<connection.ArangoApiResponse<CollectionDescription & CollectionProperties & {
        revision: string;
    }>>;
    /**
     ...
     * ```
     */
    checksum(options?: CollectionChecksumOptions): Promise<connection.ArangoApiResponse<CollectionDescription & {
        revision: string;
        checksum: string;
    }>>;
    /**
     ...
     * ```
     */
    documentExists(selector: documents.DocumentSelector, options?: documents.DocumentExistsOptions): Promise<boolean>;
    /**
     ...
     * ```
     */
    document(selector: documents.DocumentSelector, options?: documents.ReadDocumentOptions): Promise<documents.Document<EntryResultType>>;
    /**
     * Retrieves the document matching the given key or id.
     *
     * Throws an exception when passed a document or `_id` from a different
     ...
     * ```
     */
    document(selector: documents.DocumentSelector, graceful: boolean): Promise<documents.Document<EntryResultType>>;
    /**
     ...
     * ```
     */
    documents(selectors: (string | documents.ObjectWithDocumentKey)[], options?: documents.BulkReadDocumentsOptions): Promise<documents.Document<EntryResultType>[]>;
    /**
     ...
     * ```
     */
    save(data: documents.DocumentData<EntryInputType>, options?: documents.InsertDocumentOptions): Promise<documents.DocumentOperationMetadata & {
     ...
     * ```
     */
    saveAll(data: Array<documents.DocumentData<EntryInputType>>, options?: documents.InsertDocumentOptions): Promise<Array<(documents.DocumentOperationMetadata & {
        new?: documents.Document<EntryResultType>;
        old?: documents.Document<EntryResultType>;
     ...
     * ```
     */
    replace(selector: documents.DocumentSelector, newData: documents.DocumentData<EntryInputType>, options?: documents.ReplaceDocumentOptions): Promise<documents.DocumentOperationMetadata & {
        new?: documents.Document<EntryResultType>;
        old?: documents.Document<EntryResultType>;
    }>;
    /**
     ...
     * ```
     */
    replaceAll(newData: Array<documents.DocumentData<EntryInputType> & ({
        _key: string;
    } | {
        _id: string;
    })>, options?: Omit<documents.ReplaceDocumentOptions, "ifMatch">): Promise<Array<(documents.DocumentOperationMetadata & {
        new?: documents.Document<EntryResultType>;
        old?: documents.Document<EntryResultType>;
    }) | documents.DocumentOperationFailure>>;
    /**
     ...
     * ```
     */
    update(selector: documents.DocumentSelector, newData: documents.Patch<documents.DocumentData<EntryInputType>>, options?: documents.UpdateDocumentOptions): Promise<documents.DocumentOperationMetadata & {
        new?: documents.Document<EntryResultType>;
        old?: documents.Document<EntryResultType>;
    }>;
    /**
     ...
     * ```
     */
    updateAll(newData: Array<documents.Patch<documents.DocumentData<EntryInputType>> & ({
        _key: string;
    } | {
        _id: string;
    })>, options?: Omit<documents.UpdateDocumentOptions, "ifMatch">): Promise<Array<(documents.DocumentOperationMetadata & {
        new?: documents.Document<EntryResultType>;
        old?: documents.Document<EntryResultType>;
    }) | documents.DocumentOperationFailure>>;
    /**
     ...
     * ```
     */
    remove(selector: documents.DocumentSelector, options?: documents.RemoveDocumentOptions): Promise<documents.DocumentMetadata & {
        old?: documents.Document<EntryResultType>;
    }>;
    /**
     ...
     * ```
     */
    removeAll(selectors: (string | documents.ObjectWithDocumentKey)[], options?: Omit<documents.RemoveDocumentOptions, "ifMatch">): Promise<Array<(documents.DocumentMetadata & {
        old?: documents.Document<EntryResultType>;
    }) | documents.DocumentOperationFailure>>;
    /**
     ...
     * ```
     */
    import(data: documents.DocumentData<EntryInputType>[], options?: documents.ImportDocumentsOptions): Promise<documents.ImportDocumentsResult>;
    /**
     * Bulk imports the given `data` into the collection.
     *
     ...
     * ```
     */
    import(data: any[][], options?: documents.ImportDocumentsOptions): Promise<documents.ImportDocumentsResult>;
    /**
     * Bulk imports the given `data` into the collection.
     *
     ...
     * ```
     */
    import(data: Buffer | Blob | string, options?: documents.ImportDocumentsOptions & {
     ...
     * ```
     */
    indexes<IndexType extends indexes.IndexDescription | indexes.HiddenIndexDescription = indexes.IndexDescription>(options?: indexes.ListIndexesOptions): Promise<IndexType[]>;
    /**
     ...
     * ```
     */
    ensureIndex(options: indexes.EnsurePersistentIndexOptions): Promise<connection.ArangoApiResponse<indexes.PersistentIndexDescription & {
     ...
     * ```
     */
    ensureIndex(options: indexes.EnsureTtlIndexOptions): Promise<connection.ArangoApiResponse<indexes.TtlIndexDescription & {
        isNewlyCreated: boolean;
    }>>;
    /**
     ...
     * ```
     */
    ensureIndex(options: indexes.EnsureGeoIndexOptions): Promise<connection.ArangoApiResponse<indexes.GeoIndexDescription & {
        isNewlyCreated: boolean;
    }>>;
    /**
     ...
     * ```
     */
    ensureIndex(options: indexes.EnsureInvertedIndexOptions): Promise<connection.ArangoApiResponse<indexes.InvertedIndexDescription & {
        isNewlyCreated: boolean;
    }>>;
    /**
     ...
     * ```
     */
    ensureIndex(options: indexes.EnsureVectorIndexOptions): Promise<connection.ArangoApiResponse<indexes.VectorIndexDescription & {
        isNewlyCreated: boolean;
    }>>;
    /**
     ...
     * ```
     */
    ensureIndex(options: indexes.EnsureIndexOptions): Promise<connection.ArangoApiResponse<indexes.IndexDescription & {
        isNewlyCreated: boolean;
    }>>;
    /**
     ...
     * ```
     */
    dropIndex(selector: indexes.IndexSelector): Promise<connection.ArangoApiResponse<{
        id: string;
    }>>;
}
/**
...
export interface EdgeCollection<EntryResultType extends Record<string, any> = any, EntryInputType extends Record<string, any> = EntryResultType> extends DocumentCollection<EntryResultType, EntryInputType> {
     ...
     * ```
     */
    document(selector: documents.DocumentSelector, options?: documents.ReadDocumentOptions): Promise<documents.Edge<EntryResultType>>;
    /**
     * Retrieves the document matching the given key or id.
     *
     * Throws an exception when passed a document or `_id` from a different
     ...
     * ```
     */
    document(selector: documents.DocumentSelector, graceful: boolean): Promise<documents.Edge<EntryResultType>>;
    /**
     * Retrieves the documents matching the given key or id values.
     *
     * Throws an exception when passed a document or `_id` from a different
     ...
     * ```
     */
    documents(selectors: (string | documents.ObjectWithDocumentKey)[], options?: documents.BulkReadDocumentsOptions): Promise<documents.Edge<EntryResultType>[]>;
    /**
     * Inserts a new document with the given `data` into the collection.
     *
     * @param data - The contents of the new document.
     ...
     * ```
     */
    save(data: documents.EdgeData<EntryInputType>, options?: documents.InsertDocumentOptions): Promise<documents.DocumentOperationMetadata & {
     ...
     * ```
     */
    saveAll(data: Array<documents.EdgeData<EntryInputType>>, options?: documents.InsertDocumentOptions): Promise<Array<(documents.DocumentOperationMetadata & {
        new?: documents.Edge<EntryResultType>;
        old?: documents.Edge<EntryResultType>;
    }) | documents.DocumentOperationFailure>>;
    /**
    ...
    replaceAll(newData: Array<documents.DocumentData<EntryInputType> & ({
        ...
        _id: string;
    })>, options?: documents.ReplaceDocumentOptions): Promise<Array<(documents.DocumentOperationMetadata & {
        new?: documents.Edge<EntryResultType>;
        old?: documents.Edge<EntryResultType>;
    }) | documents.DocumentOperationFailure>>;
    /**
    ...
    updateAll(newData: Array<documents.Patch<documents.DocumentData<EntryInputType>> & ({
        ...
        _id: string;
    })>, options?: documents.UpdateDocumentOptions): Promise<Array<(documents.DocumentOperationMetadata & {
        new?: documents.Edge<EntryResultType>;
        old?: documents.Edge<EntryResultType>;
    }) | documents.DocumentOperationFailure>>;
    /**
     ...
     * ```
     */
    removeAll(selectors: documents.DocumentSelector[], options?: documents.RemoveDocumentOptions): Promise<Array<(documents.DocumentMetadata & {
        old?: documents.Edge<EntryResultType>;
    }) | documents.DocumentOperationFailure>>;
    /**
     * Bulk imports the given `data` into the collection.
     ...
     * ```
     */
    import(data: documents.EdgeData<EntryInputType>[], options?: documents.ImportDocumentsOptions): Promise<documents.ImportDocumentsResult>;
    /**
     * Bulk imports the given `data` into the collection.
     *
     * @param data - The data to import, as an array containing a single array of
     ...
     * ```
     */
    edges(selector: documents.DocumentSelector, options?: documents.DocumentEdgesOptions): Promise<connection.ArangoApiResponse<documents.DocumentEdgesResult<EntryResultType>>>;
    /**
     ...
     * ```
     */
    inEdges(selector: documents.DocumentSelector, options?: documents.DocumentEdgesOptions): Promise<connection.ArangoApiResponse<documents.DocumentEdgesResult<EntryResultType>>>;
    /**
     ...
     * ```
     */
    outEdges(selector: documents.DocumentSelector, options?: documents.DocumentEdgesOptions): Promise<connection.ArangoApiResponse<documents.DocumentEdgesResult<EntryResultType>>>;
}
/**
 * @internal
 */
export declare class Collection<EntryResultType extends Record<string, any> = any, EntryInputType extends Record<string, any> = EntryResultType> implements EdgeCollection<EntryResultType, EntryInputType>, DocumentCollection<EntryResultType, EntryInputType> {
    ...
    documentId(selector: documents.DocumentSelector): string;
    documentExists(selector: documents.DocumentSelector, options?: documents.DocumentExistsOptions): Promise<boolean>;
    documents(selectors: (string | documents.ObjectWithDocumentKey)[], options?: documents.BulkReadDocumentsOptions): Promise<any>;
    document(selector: documents.DocumentSelector, options?: boolean | documents.ReadDocumentOptions): Promise<any>;
    save(data: documents.DocumentData<EntryInputType>, options?: documents.InsertDocumentOptions): Promise<any>;
    saveAll(data: Array<documents.DocumentData<EntryInputType>>, options?: documents.InsertDocumentOptions): Promise<any>;
    replace(selector: documents.DocumentSelector, newData: documents.DocumentData<EntryInputType>, options?: documents.ReplaceDocumentOptions): Promise<any>;
    replaceAll(newData: Array<documents.DocumentData<EntryInputType> & ({
        _key: string;
    } | {
        _id: string;
    })>, options?: documents.ReplaceDocumentOptions): Promise<any>;
    update(selector: documents.DocumentSelector, newData: documents.Patch<documents.DocumentData<EntryInputType>>, options?: documents.UpdateDocumentOptions): Promise<any>;
    updateAll(newData: Array<documents.Patch<documents.DocumentData<EntryInputType>> & ({
        _key: string;
    } | {
        _id: string;
    })>, options?: documents.UpdateDocumentOptions): Promise<any>;
    remove(selector: documents.DocumentSelector, options?: documents.RemoveDocumentOptions): Promise<any>;
    removeAll(selectors: (string | documents.ObjectWithDocumentKey)[], options?: documents.RemoveDocumentOptions): Promise<any>;
    import(data: Buffer | Blob | string | any[], options?: documents.ImportDocumentsOptions & {
        type?: "" | "documents" | "list" | "auto";
    }): Promise<documents.ImportDocumentsResult>;
    protected _edges(selector: documents.DocumentSelector, options?: documents.DocumentEdgesOptions, direction?: "in" | "out"): Promise<any>;
    edges(vertex: documents.DocumentSelector, options?: documents.DocumentEdgesOptions): Promise<any>;
    inEdges(vertex: documents.DocumentSelector, options?: documents.DocumentEdgesOptions): Promise<any>;
    outEdges(vertex: documents.DocumentSelector, options?: documents.DocumentEdgesOptions): Promise<any>;
    loadIndexes(): Promise<boolean>;
    indexes(options?: indexes.ListIndexesOptions): Promise<any>;
    index(selector: indexes.IndexSelector): Promise<any>;
    ensureIndex(options: indexes.EnsureIndexOptions): Promise<any>;
    dropIndex(selector: indexes.IndexSelector): Promise<any>;
}
