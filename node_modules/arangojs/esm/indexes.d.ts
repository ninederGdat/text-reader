 ...
 */
export type EnsureIndexOptions = EnsurePersistentIndexOptions | EnsureGeoIndexOptions | EnsureTtlIndexOptions | EnsureMdiIndexOptions | EnsureMdiPrefixedIndexOptions | EnsureInvertedIndexOptions | EnsureVectorIndexOptions;
/**
 * Shared attributes of all index creation options.
 */
export type EnsureIndexOptionsType<Type extends IndexType, Fields extends any[], Extra extends {} = {}> = {
    /**
 ...
 */
export type EnsurePersistentIndexOptions = EnsureIndexOptionsType<"persistent", string[], {
    /**
 ...
 */
export type EnsureGeoIndexOptions = EnsureIndexOptionsType<"geo", [
    string,
    string
] | [string], {
    /**
 ...
 */
export type EnsureTtlIndexOptions = EnsureIndexOptionsType<"ttl", [
    string
], {
    /**
 ...
 */
export type EnsureMdiPrefixedIndexOptions = EnsureIndexOptionsType<"mdi-prefixed", string[], {
    /**
 ...
 */
export type EnsureVectorIndexOptions = EnsureIndexOptionsType<"vector", [
    string
], {
    /**
 ...
 */
export type IndexDescription = FulltextIndexDescription | GeoIndexDescription | PersistentIndexDescription | TtlIndexDescription | MdiIndexDescription | MdiPrefixedIndexDescription | InvertedIndexDescription | SystemIndexDescription | VectorIndexDescription;
/**
 * An object representing a system index.
 */
export type SystemIndexDescription = PrimaryIndexDescription | EdgeIndexDescription;
/**
 ...
 */
export type PersistentIndexDescription = IndexDescriptionType<"persistent", string[], {
    cacheEnabled: boolean;
    deduplicate: boolean;
    estimates: boolean;
 ...
 */
export type PrimaryIndexDescription = IndexDescriptionType<"primary", [
    "_key"
], {
    selectivityEstimate: number;
}>;
 ...
 */
export type EdgeIndexDescription = IndexDescriptionType<"edge", [
    "_from",
    "_to"
], {
    selectivityEstimate: number;
 ...
 */
export type FulltextIndexDescription = IndexDescriptionType<"fulltext", [
    string
], {
    minLength: number;
}>;
 ...
 * An object representing an edge index.
 */
export type EdgeIndex = IndexDescriptionType<"edge", [
    "_from",
    "_to"
], {
    selectivityEstimate: number;
 ...
 */
export type FulltextIndex = IndexDescriptionType<"fulltext", [
    string
], {
    minLength: number;
}>;
 ...
 */
export type GeoIndexDescription = IndexDescriptionType<"geo", [
    string
] | [string, string], {
    geoJson: boolean;
    legacyPolygons: boolean;
 ...
 */
export type TtlIndexDescription = IndexDescriptionType<"ttl", [
    string
], {
    expireAfter: number;
    estimates: boolean;
 ...
 */
export type MdiIndexDescription = IndexDescriptionType<"mdi", string[], {
    fieldValueTypes: "double";
    estimates: boolean;
    selectivityEstimate: number;
    storedValues?: string[];
 ...
 */
export type MdiPrefixedIndexDescription = IndexDescriptionType<"mdi-prefixed", string[], {
    fieldValueTypes: "double";
    estimates: boolean;
    selectivityEstimate: number;
    storedValues?: string[];
 ...
 */
export type InvertedIndexDescription = IndexDescriptionType<"inverted", InvertedIndexField[], {
    searchField: boolean;
    cache?: boolean;
    storedValues: {
        fields: string[];
 ...
 */
export type VectorIndexDescription = IndexDescriptionType<"vector", [
    string
], {
    parallelism: number;
    inBackground: boolean;
